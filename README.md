...
[![My Skills](https://skills.thijs.gg/icons?i=html,css,js,ts,react,unity)](https://skills.thijs.gg)
...
Réalisée lors de ma fonction d'ingénieur en électrotechnique (2021), il s'agissait dans un premier temps de réaliser une IHM utilisable de façon locale sur un pupitre opérateur industriel, elle avait donc été programmée via Tia Portal ; puis, il a fallu rendre les informations accessibles sur un ordinateur à distance, pour cela, j'ai réalisé une page web recevant et affichant les données de l'automate (envoyée par le web server de Tia Portal). Pour des raisons évidentes de confidentialités, la présentation du projet sur GitHub est une reproduction très modifiée, simplifiée, et ne dévoilant aucune informations sur les composants électrotechniques utilisés. Pour plus de détails :  Le [code](https://github.com/AdrienVers/IHM-industrielle) sur GitHub et le [site](https://adrienvers.github.io/IHM-Industrielle/).
