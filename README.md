...
##### ![React](https://img.shields.io/badge/React-20232A?style=for-the-badge&logo=react&logoColor=61DAFB) React (v19) :
...
##### ![Angular](https://img.shields.io/badge/Angular-DD0031?style=for-the-badge&logo=angular&logoColor=white) Angular (v20) : 

[Injection de dépendance (DI) en Angular](https://angular.dev/tutorials/learn-angular/20-inject-based-di).

##### ![Vue.js](https://img.shields.io/badge/Vue.js-35495E?style=for-the-badge&logo=vuedotjs&logoColor=4FC08D) VueJS (v3.5) / NuxtJS (v4) :
...
[Méthodes utilisables pour les tests unitaires avec Jest](https://jestjs.io/docs/expect).
...
[Comparatif des différentes librairies permettant de créer des graphiques en React (Nivo, Victory, React-chartjs-2, Recharts)](https://blog.logrocket.com/top-8-react-chart-libraries/).
...
[Imgur (simple d'utilisation, mais génère des problèmes d'accès lors des upload en localhost)](https://imgur.com/), 

[Cloudinary (simple d'utilisation, mais génère des problèmes de cookies)](https://cloudinary.com/), 
...
[Thème et couleur de script non agressif pour VS Code (Default Themes : Dark+)](https://code.visualstudio.com/docs/getstarted/themes).
